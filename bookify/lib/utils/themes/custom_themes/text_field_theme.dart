...
class MyTextFormFieldTheme {
  ...
  static final darkInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle(fontSize: 14, color: AppColor.neutral_60),
    hintStyle: const TextStyle(fontSize: 14, color: AppColor.neutral_60),
    helperStyle: const TextStyle(fontSize: 10, color: AppColor.neutral_60),
    counterStyle: const TextStyle(fontSize: 10, color: AppColor.neutral_60),
    errorStyle: const TextStyle(fontSize: 10, fontStyle: FontStyle.normal, color: AppColor.neutral_40),
    iconColor: AppColor.neutral_70,
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(8),
      borderSide: BorderSide(
        color: AppColor.neutral_80,
        width: 1,
      ),
    ),
  ...
  static final lightInputDecorationTheme = InputDecorationTheme(
    ...
    helperStyle: const TextStyle(fontSize: 10, color: AppColor.neutral_40),
    counterStyle: const TextStyle(fontSize: 10, color: AppColor.neutral_40),
    errorStyle: const TextStyle(fontSize: 10, fontStyle: FontStyle.normal, color: AppColor.black),
