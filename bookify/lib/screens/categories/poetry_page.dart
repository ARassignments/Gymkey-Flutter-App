...
class _PoetryPageState extends State<PoetryPage> {
  ...
  // Firestore: only category filter; sorting/search are client-side
  void _updateStream() {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Categories List (with selected highlight)
            Padding(
            ...
            // Filter + Title Row (same as Featured)
            Padding(
              ...
              child: Padding(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    // 3) Sort in-memory (same logic as Featured)
                    computed.sort((a, b) {
