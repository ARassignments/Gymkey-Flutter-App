...
class _NovelsPageState extends State<NovelsPage> {
  ...
  String _selectedCategory = 'Novels';
  ...
  // Simple stream; sorting & search are client-side only
  void _updateStream() {
    _booksStream = FirebaseFirestore.instance
        .collection('books')
        .where('genre', isEqualTo: 'Novels')
        .snapshots();
  }
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Categories List (unchanged, like Featured)
            Padding(
            ...
            // Filter + Title Row — same pattern as Featured
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    q.isEmpty ? "Novels" : 'Results for “$q”',
              ...
              child: Padding(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    // 3) Sort using the precomputed fields (client-side) — SAME AS Featured
                    computed.sort((a, b) {
