...
class SelfLovePage extends StatefulWidget {
  const SelfLovePage({super.key});

  @override
  State<SelfLovePage> createState() => _SelfLovePageState();
}
...
class _SelfLovePageState extends State<SelfLovePage> {
  ...
  String _selectedCategory = 'Self Love';
  ...
  // Firestore: genre-only filter; search/sort are client-side
  void _updateStream() {
  ...
  bool _matchesQuery(Map<String, dynamic> book, String query) {
    ...
    for (final t in terms) {
      ...
      if (!termOK(t)) return false; // AND across multiple terms
    }
    return true;
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    q.isEmpty ? '$_selectedCategory Books' : 'Results for “$q”',
