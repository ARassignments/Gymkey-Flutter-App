...
class _FantasyPageState extends State<FantasyPage> {
  ...
  // ✅ selected category + mutable categories list (History pattern)
  ...
  // ✅ HistoryPage jaisa: selected ko index 0 par lao
  ...
  // ✅ Pehle state + reorder + stream; phir navigate (exactly History pattern)
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Filter + Title Row (History pattern)
            Padding(
              ...
              child: Padding(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    // 1) Live search filter (client-side)
