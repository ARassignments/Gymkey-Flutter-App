...
class _HistoryPageState extends State<HistoryPage> {
  ...
  // NOTE: PoetryPage ki tarah MUTABLE list (const nahi), taa-ke reorder ho sake
  ...
  // ✅ PoetryPage wali hi logic: selected ko index 0 par le aao
  ...
  // ✅ Firestore: category filter dynamic (selectedCategory ke hisaab se)
  void _updateStream() {
  ...
  // ✅ Pehle state update + reorder + stream update; phir navigate (Poetry jaisa)
  ...
  bool _matchesQuery(Map<String, dynamic> book, String query) {
    ...
    for (final t in terms) {
      ...
      if (!termOK(t)) return false; // AND across terms
    }
    return true;
  }
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Categories List (selected pehle dikhega + highlight)
            Padding(
            ...
            // Filter + Title Row (Poetry jaisa dynamic)
            Padding(
