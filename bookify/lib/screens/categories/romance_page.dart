...
class _RomancePageState extends State<RomancePage> {
  ...
  // client-side sort state (Featured style)
  ...
  void _onSearchChanged() => setState(() {}); // live re-render

  // Firestore: only filter by selected genre; search/sort are client-side
  void _updateStream() {
  ...
  // change sort mode (in-memory only)
              ...
              child: Padding(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    // 2) Precompute data for robust sorting
                    ...
                    // 3) Sort using the precomputed fields
                    computed.sort((a, b) {
